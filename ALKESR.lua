...
do-- by @wajdilraqi
local function wajdilraqi(msg, matches)
if matches[1] == "الاوامر" then
local helps =  [[
اهـ♥️ـلآ بـ🌟ـك يـاعـ✨ـزيــ💫ــزي لـ❄️ـقـد تـ√ـم عـ🌝ـرض لـ🌚ـك الاوامـ💐ـر سـ🐺ـورس الــقــ😻ـيـ🌝ـصــر > @wajdilraqi قناة السورس @wwm1m
🍷▁▁▁▁▁▁▁▁▁▁▁▁▁▁🍷
