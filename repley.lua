...
ws[132] = "مطور"  
rs[132] = "مطور البوت @wajdilraqi 💋😻 "

ws[133] = "@wajdilraqi" 
rs[133] = "فديت ربه 🙊 هذا مطور السورس 😻❤️"

ws[134] ="اريد قناة"
rs[134] =" https://telegram.me/wwm1m 😌"
...
قناة السورس @wwm1m
مطورين السورس
@wajdilraqi #القيصر وجدي "



ws[244] = "المطور"
rs[244] = "وجدي حياتي تاج راسي 
@wajdilraqi
#القيصر وجدي "
...
function II02II( msg, matches )
	...
	if ( msg.text == "about" ) then
		if ( msg.from.username == "Memo" ) then
			R = get_receiver(msg)
			send_large_msg ( R , "Made by @wwm1m" );
		end
	end 
